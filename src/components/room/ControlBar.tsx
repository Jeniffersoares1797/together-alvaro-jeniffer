...
export function ControlBar({
  ...
  return (
    <div
      className={`fixed bottom-6 left-1/2 -translate-x-1/2 z-40 max-w-fit px-3 py-2 rounded-2xl bg-[#110e0c]/90 backdrop-blur-xl border border-white/[0.08] shadow-[0_20px_50px_rgba(0,0,0,0.85)] flex items-center gap-1.5 sm:gap-2 transition-all duration-300 ${
    ...
    >
      ...
      <div className="w-[1px] h-5 bg-white/[0.08] mx-0.5" />

      {/* 4. Assistir (TV) */}
      <button
        onClick={onOpenWatchModal}
        className="p-2.5 rounded-xl bg-white/[0.06] hover:bg-white/[0.12] text-[#ede7df] transition-all flex items-center justify-center cursor-pointer active:scale-95"
      ...
      <button
        ...
        className="p-2.5 rounded-xl bg-amber-500/10 hover:bg-amber-500/20 text-amber-300/90 border border-amber-500/20 transition-all flex items-center justify-center cursor-pointer active:scale-95"
      ...
      <button
        ...
        className="hidden sm:flex p-2.5 rounded-xl bg-white/[0.06] hover:bg-white/[0.12] text-rose-300/80 hover:text-rose-200 transition-all items-center justify-center cursor-pointer active:scale-95"
      ...
      <button
        onClick={onOpenChat}
        className="relative p-2.5 rounded-xl bg-white/[0.06] hover:bg-white/[0.12] text-[#ede7df] transition-all flex items-center justify-center cursor-pointer active:scale-95"
        title="Chat"
      >
      ...
      <button
        onClick={onLeaveRoom}
        className="p-2.5 rounded-xl bg-rose-500/10 hover:bg-rose-500/20 text-rose-400/80 hover:text-rose-300 transition-all flex items-center justify-center cursor-pointer active:scale-95"
        title="Sair da Sala"
      >
